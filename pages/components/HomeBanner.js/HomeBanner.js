...
const IconCard = ({ Icon, text }) => (
    <div className="flex items-center gap-1 p-2 bg-[#556ee6] h-[64px] xl:text-sm lg:text-xs text-xs border-[1px] border-black lg:rounded-full rounded-md lg:hover:scale-105 xl:w-[330px] lg:w-[220px] w-full">
...
const ImageChange = ({ locname, place }) => {
    ...
    return (
        <div className="xl:mt-0 lg:mt-0 xl:px-20 xl:pr-32 lg:pl-4 px-2 py-2 pb-5">
            <div className="bg-white">
                <div className="lg:flex lg:flex-row-reverse flex flex-col justify-between items-center lg:pl-10 xl:px-0">
                    {/* Banner Image with explicitly defined width and height to avoid CLS */}
                    <div className="relative xl:w-[350px] lg:w-[350px] w-[300px] h-[350px]">
                        <Image
                            src={homebanner}
                            alt="Dozzy app"
                            width={450}
                            height={450}
                            layout="intrinsic" // Ensures the image takes up space immediately
                            className="object-cover lg:scale-125"
                            fetchPriority="high" // Ensure image loading is prioritized
                        />
                    </div>
                    ...
                    <div className="lg:text-left xl:pl-0 lg:pl-4 text-black font-[500] xl:text-base text-xl lg:pt-10 pt-3">
                        ...
                        <div className="flex flex-col justify-center lg:justify-normal lg:gap-8 pt-2 gap-2 w-full text-sm md:text-xs xl:text-base">
                            <div className="flex gap-2 py-2 justify-center lg:justify-normal items-center relative">
                                {/* Apple and Google images with fixed size to avoid CLS */}
