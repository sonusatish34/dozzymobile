...
const FarmStarts = () => {
    return (
        <div className='py-6 px-4'>
            <p className='pb-2'>Farmhouses Starts At 13,000/day</p>
            <div className='flex'>
                <div >
                    <Image
                        src={grpfarm}
                ...
                <div>
                    <p className='text-[11px] pl-3'>Dozzy Has 10,000+ Attached
                        Farmhouses From Basic - Luxury
                        It's Just Starting At 13,000/day
                        Only To View More</p>
                    <div className='flex gap-1 text-white pt-3 pl-4'>
                        <button className='bg-green-500 rounded-full py-1 px-2'>
