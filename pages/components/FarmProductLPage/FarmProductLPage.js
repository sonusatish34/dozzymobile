        ...
        return (
            <div className="flex justify-between font-normal text-xs ">
                <div className="flex flex-col gap-y-2 border-2 border-gray-300 rounded-lg p-1">
                    <div><p className="underline tracking-wide text-xs mxs:text-sm">8000 / 11 hrs</p></div>
                                                    ...
                                                    <div className="bg-red-2 rounded-lg shadow-lg overflow-hidden flex justify-center flex-col xl:w-[360px] lg:w-[260px] w-[100%] px-1 md:w-80 h-[680px] ">
                                                        ...
                                                        <div className="px- flex flex-col justify-center  gap-4">
                                                            ...
                                                            <div className="flex justify-between px-2">
                                                                <TimeCard  price={'8000'} hrs={'11'} checkin={'11'} checkout={'11'} />
                                                                <TimeCard />
                                                                <TimeCard />
                                                            ...
                                                            <div className="flex flex-col justify-between  text-white">
                                                                <ul className="flex justify-center gap-x-1 w-full px-3 pb-4">
                                                                    <li className="bg-green-500 w-full py-3 px-2  text-center rounded-md ">
                                                                        {" "}
                                                                        <Link
                                                                    ...
                                                                    <li className="bg-blue-500 w-full py-3 px-2 rounded-md ">
