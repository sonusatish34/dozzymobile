...
function Kukatpally({ canonicalUrl }) {
    return (
        <div className='bg-white'>
            <Head>
                <title> Kukatpally Farmhouse Rentals | Peaceful Retreats</title>
                <meta name="description" content="Find fun and comfortable farmhouses in Kukatpally. Great for birthdays, family get-togethers, and relaxing in nature with your loved ones." />
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <meta property="og:title" content="Kukatpally Farmhouse Rentals | Peaceful Retreats" />
                <meta property="og:description" content="Find fun and comfortable farmhouses in Kukatpally. Great for birthdays, family get-togethers, and relaxing in nature with your loved ones." />
            ...
            <div className='text-black lg:px-20 px-4 leading-9 lg:leading-10 pt-4 lg:pt-16'>
                ...
                <NearByFarm lat={'17.488375396886987'} lon={'78.38168230682999'} loc={"Kukatpally"} />
