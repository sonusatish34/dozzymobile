    ...
    return (
        <div className='bg-white'>
            <Head>
                ...
                <title>Best Farmhouses in ECIL – Book with Dozzy</title>
                <meta name="robots" content="index, follow" />
                <meta name="description" content="Explore fun farmhouses in ECIL for parties or short stays. Enjoy big lawns, clean pools, and friendly service for the whole family." />
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <meta property="og:title" content="Best Farmhouses in ECIL – Book with Dozzy" />
                <meta name="og:description" content="Explore fun farmhouses in ECIL for parties or short stays. Enjoy big lawns, clean pools, and friendly service for the whole family." />
            ...
            <div className='text-black lg:px-20 px-4 leading-9 lg:leading-10 pt-4 lg:pt-16'>
                ...
                <div>
                                    ...
                                    <NearByFarm lat={'17.4686'} lon={'78.5651'} loc={"Ecil"} />
