...
//   console.log(router,"mm");
//   console.log(customData[`${a}`],"cd");
console.log(farmproduct,"farmhouse");
      ...
      <div className=' lg:px-2 mx-auto lg:mx-36 xl:mx-16 md:p-28 lg:p-4 xs:px-5 sm:pt-44 px-2 py-2'>
        <div className='flex flex-col xs:mt-48 md:mt-20 lg:mt-2 md:flex-row p-2 border-2 border-orange-400 rounded-md'>
          ...
          <div className='flex flex-col justify-evenly'>
            <div>
              <h2 className='p-1 font-bold font-manrope text-lg lg:pl-20'>{customData[farmproduct?.toLowerCase()]?.id}</h2>
              <h2 className='p-1 font-bold md:text-3xl text-xl lg:pl-20'><span className='text-lg'>Starting from</span><span className='text-blue-400'> {customData[farmproduct?.toLowerCase()]?.price_24_hours}/day</span></h2>
            </div>
            
          </div>
        </div>
        <div className='pt-6 lg:hidden'>
          <h2 className='font-semibold text-2xl font-manrope pb-2'>Contact Us By</h2>
