...
function Secunderabad({ canonicalUrl }) {
    return (
        <div className='bg-white'>
            <Head>
                <title>Book a Happy Farmhouse in Secunderabad</title>
                <meta name="description" content="Spend your weekend at a farmhouse with trees, space, and fun things to do. Perfect for kids, families, and birthday fun." />
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <meta property="og:title" content="Book a Happy Farmhouse in Secunderabad" />
                <meta property="og:description" content="Spend your weekend at a farmhouse with trees, space, and fun things to do. Perfect for kids, families, and birthday fun." />
            ...
            <div className='text-black lg:px-20 px-4 leading-9 lg:leading-10 pt-4 lg:pt-16'>
                ...
                <NearByFarm lat={'17.440142735958126'} lon={'78.49812939497535'} loc={"Secunderabad"} />
