  ...
  return (
    <div className='text-black lg:px-20 px-6 grotesk-text lg:leading-8 lg:text-sm text-xs leading-6'>
      <Head>
        ...
        <title>Dozzy Farmhouse Refund Rules & Cancellations</title>
        <meta name="robots" content="index, follow" />
        <meta name="description" content="Learn how to cancel farmhouse bookings on Dozzy. It’s super easy, clear, and made to help you if your plans change." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Dozzy Farmhouse Refund Rules & Cancellations" />
        <meta name="og:description" content="Learn how to cancel farmhouse bookings on Dozzy. It’s super easy, clear, and made to help you if your plans change." />
...
export async function getServerSideProps({ req, query, params }) {
  ...
  const canonicalUrl = host.includes('.in')
    ? `https://www.dozzy.in/bangalore/cancellation-and-refund`
    : `https://www.dozzy.com/bangalore/cancellation-and-refund`;
