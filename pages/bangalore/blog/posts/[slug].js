...
export async function getServerSideProps({ req, params }) {
  ...
  try {
    ...
    if (postDisplay?.blogfor !== 'Dozzy' && postDisplay?.blogfor !== 'DozzyBng') {
      return {
    ...
    const canonicalUrl = host.includes('.in')
      ? `https://www.dozzy.in/bangalore/blog/posts/${(postDisplay.slug)}`
      : `https://www.dozzy.com/bangalore/blog/posts/${(postDisplay.slug)}`;
