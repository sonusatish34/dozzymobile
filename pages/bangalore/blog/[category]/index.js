                    ...
                    <div className='xl:px-24 lg:px-20 text-black flex items-center helvetica-font'>
                        <div className='lg:py-10 py-5  px-[6px]'>
                            ...
                            <div className='text-center pt-10'>
                                <PostsListing loc={'bangalore'} catg={category} data={filteredPosts} />
                            </div>
                            {/* <p>kjo</p> */}
                            <RandomPosts loc={'bangalore'} data={randomPostlist} />
                        </div>
                    </div>
                    <div className=" py-2 pb-9 lg:py-5 flex flex-row xl:pl-28 lg:pl-24 pl-4 helvetica-font text-white">
                        <Link href={`/bangalore/blog/${category ? category + '/' : ''}recommended`} className="flex space-x-2">
...
export async function getServerSideProps(context) {
    ...
    const canonicalUrl = host.includes('.in')
        ? `https://www.dozzy.in/bangalore/blog/${category}`
        : `https://www.dozzy/bangalore/blog/${category}`;
