...
export default function privacy_policy({ canonicalUrl }) {
  return (
    <div className='text-black lg:px-20 px-6 grotesk-text lg:leading-8 lg:text-sm text-xs leading-6'>
      <Head>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <title>Dozzy Cares About Your Privacy</title>
        <meta name="robots" content="index, follow" />
        <meta name="description" content="We protect your info and tell you clearly how we use it. Your safety is important to us." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Dozzy Cares About Your Privacy" />
        <meta name="og:description" content="We protect your info and tell you clearly how we use it. Your safety is important to us." />
      ...
      <ol className='pl-6'>
        ...
        <li className='list-decimal pb-4'>The Site’s primary goal in collecting personal information is to provide you, the member, with a potentially fulfilling experience. The information collected by the Site is protected by the use of appropriate technical and security measures to prevent unauthorized or unlawful access to or accidental loss of or destruction or damage to your information. However, it is brought to your notice that when you use our services or post on the Site, some of the Personal Information you share is visible to other users and can be read, collected, or used by them. You are responsible for such Personal Information you choose to submit in these instances.</li>
      </ol>
      <p id='cancellation-refund' className='font-bold text-lg pt-6 pb-3 border-t-2 border-t-gray-300'>Cancellation & Refund policy</p>
...
export async function getServerSideProps({ req, query, params }) {
  ...
  const canonicalUrl = host.includes('.in')
    ? `https://www.dozzy.in/bangalore/privacy-policy`
    : `https://www.dozzy.com/bangalore/privacy-policy`;
