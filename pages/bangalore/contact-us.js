...
export async function getServerSideProps({ req }) {
  ...
  const canonicalUrl = host.includes('.in')
    ? 'https://www.dozzy.in/bangalore/contact-us'
    : 'https://www.dozzy.com/bangalore/contact-us';
  ...
  try {
    const response = await fetch(
      'https://api.dozzy.com/customer/approved_properties?lat=12&long=77&program_id=1&property_capacity=1000',
      requestOptions
    );
